...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	protected void onDraw( final Canvas canvas ) {
		...
		if( this.mOrientation == CirclePageIndicator.HORIZONTAL ) {
	...
	private void updatePageSize() {
		if( this.mViewPager != null ) {
			this.mPageSize = (this.mOrientation == CirclePageIndicator.HORIZONTAL) ? this.mViewPager.getWidth() : this.mViewPager.getHeight();
		}
	}
}
