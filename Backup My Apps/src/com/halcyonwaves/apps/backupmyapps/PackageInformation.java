...
public class PackageInformation {
	...
	public boolean isSystemComponent() {
		return this.pname.toLowerCase().startsWith( "com.android." ) || this.pname.toLowerCase().startsWith( "com.example" ) || this.pname.equalsIgnoreCase( "android" ) || this.pname.equalsIgnoreCase( "android.tts" ) || this.pname.toLowerCase().startsWith( "com.lge." ) || this.pname.toLowerCase().startsWith( "com.google.android." );
	}
